...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-top: -75px;">
  ...
  <!-- <?php
   // if($_SESSION['user']=="admin")
    {
     // echo '<input type="button" id="b1" value="Logout" class="text-muted" onclick="location.href="product.php"">';
    }
    ?> -->
 <input type="button" id="b1" value="Sign Up" class="text-muted" onclick="location.href='sign.php'" style="margin-top: -10px;"> &nbsp
  <input type="button" id="b1" value="login" class="text-muted" onclick="location.href='log1.php'" style="margin-top: -10px;">      
