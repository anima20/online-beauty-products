...
if ($_SESSION['user']=="") 
{
	echo '<script>alert("Need to login")</script>';
				echo '<script>window.location="moist_lotion.php"</script>';
}
else{
					...
					if (!empty($_SESSION["shopping_cart"]))
					 {
						...
						foreach ($_SESSION["shopping_cart"] as $key => $value)
						{
							...
							<tr>
								...
								<td><a href="moist_cart.php?action=delete&id=<?php echo $value["id"] ; ?>"><span class="text-danger">Remove</span></a></td>
							</tr>
							<?php
