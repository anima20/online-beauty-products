...
<div class="container py-5" style="background-image: url(images/regs6.jpg);">
	...
	<h1 style="color: white ; margin-left: 35% ; font-family: facon; font-weight: bold ; font-size: 50px">ALL PRODUCTS</h1>
					...
					while ($row=mysqli_fetch_assoc($q_run)) 
					{
						?>
							<div class="col-md-3 mt-3">
								<form action="all_cart.php?action=add&id=<?php echo $row["id"] ; ?>" method="post">
