...
<div class="container py-5" style="background-image: url(images/regs6.jpg);">
	...
	<h1 style="color: white ; margin-left: 35% ; font-family: facon; font-weight: bold ; font-size: 55px">MAKE UP</h1>
	<div class="row mt-3 " style="margin-left: -25px">
			<?php
				$con = mysqli_connect("localhost","root","","beauty");
				$q="select * from product where p_cat='Make Up'";
					...
					while ($row=mysqli_fetch_assoc($q_run)) 
					{
						?>
							<div class="col-md-3 mt-3">
								<form action="makeup_cart.php?action=add&id=<?php echo $row["id"] ; ?>" method="post">
